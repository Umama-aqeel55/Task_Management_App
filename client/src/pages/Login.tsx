...
import { KanbanSquare, Loader2, Github, Mail } from 'lucide-react';
      ...
      <div className="w-full max-w-md p-8 glass-panel rounded-2xl relative z-10 mx-4">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 mb-4">
            <KanbanSquare className="text-white h-7 w-7" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input 
                ...
                className="pl-10 bg-black/20 border-white/10 text-slate-200 placeholder:text-slate-600 focus-visible:ring-primary/50 h-11"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Input 
              ...
              className="bg-black/20 border-white/10 text-slate-200 focus-visible:ring-primary/50 h-11"
              required
            />
          </div>
          ...
          <Button 
            type="submit" 
            className="w-full h-11 bg-primary hover:bg-primary/90 text-white font-medium shadow-lg shadow-primary/25 mt-2"
            disabled={loading}
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="outline" className="h-11 border-white/10 hover:bg-white/5 hover:text-white text-slate-300">
